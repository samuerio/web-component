...
/***/ function(module, exports, __webpack_require__) {
	...
	var popWindow = {
	    _default: {
	        ...
	        ondestroy: null,
	        onload: null,
	        getWindowObj: function getWindowObj() {
	            return popWindow.settings._popWindowObj;
	        },
	        _popWindowObj: null,
	        _CloseOwnerWindow: function _CloseOwnerWindow(action) {
	    ...
	    open: function open(option) {
	        ...
	        this.settings._popWindowObj = window.open(this.settings.url, this.settings.title, 'top=' + top + ',left=' + left + ',width=' + windowWidth + ',height=' + windowHeight + ',' + strWindowFeatures);
	...
	var helper = {
	    openWindow: function openWindow(opiton) {
