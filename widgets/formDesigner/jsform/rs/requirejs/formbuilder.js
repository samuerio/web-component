...
(function() {
    ...
    $.widget("jsform.tab", {options: {ulCss: ["y", "b", "g"],normalCss: ["ny", "nb", "ng"],selectedCss: ["sy", "sb", "sg"],tabIds: ["#t1", "#t2", "#t3"],ahoverCss: "ah"},select: function(e) {
...
function showProperties(c) {
    var b = ["ptype", "pfldsize", "playout", "pdateformat", "pphoneformat", "pmoneyformat", "pnameformat", "plikert", "pitems", "pitems2", "pitems_other", "pitems_radio", "pitems_batchedit", "pitems_checkbox", "poptions", "pgoods", "pimage", "popt_required", "popt_unique", "popt_random", "popt_allowother", "popt_hidenum", "popt_authcode", "popt_compress", "popt_dismark", "psecurity", "prange", "pconfine", "pconfine1", "pconfine2", "pdefval_text", "pdefval_number", "pdefval_date", "pdefval_time", "pdefval_phone_tel", "pdefval_phone_mobile", "pdefval_addr", "pinstruct", "psection", "phtml"], a = {text: ["ptype", "pfldsize", "poptions", "popt_required", "popt_unique", "psecurity", "prange", "pdefval_text", "pinstruct", "pconfine", "pconfine1", "pconfine2"],number: ["ptype", "pfldsize", "poptions", "popt_required", "popt_unique", "psecurity", "prange", "pdefval_number", "pinstruct", "pconfine", "pconfine2"],textarea: ["ptype", "pfldsize", "poptions", "popt_required", "popt_unique", "psecurity", "prange", "pdefval_text", "pinstruct", "pconfine", "pconfine2"],checkbox: ["ptype", "playout", "poptions", "popt_required", "psecurity", "prange", "pitems", "pitems_batchedit", "pinstruct"],goods: ["ptype", "poptions", "popt_required", "psecurity", "pgoods"],goodsnoimg: ["ptype", "poptions", "popt_required", "psecurity", "pgoods"],radio: ["ptype", "playout", "poptions", "popt_required", "popt_random", "popt_allowother", "psecurity", "pitems", "pitems_other", "pitems_radio", "pinstruct", "pconfine", "pconfine2"],dropdown: ["ptype", "pfldsize", "poptions", "popt_required", "psecurity", "pitems", "pitems_radio", "pinstruct", "pconfine", "pconfine2"],dropdown2: ["ptype", "pfldsize", "poptions", "popt_required", "psecurity", "pitems", "pitems_batchedit", "pitems2", "pinstruct"],image: ["ptype", "pimage", "psecurity"],map: ["poptions", "popt_required", "psecurity", "pinstruct", "popt_dismark"],section: ["psecurity", "psection"],html: ["psecurity", "phtml"],likert: ["ptype", "plikert", "poptions", "popt_required", "popt_hidenum", "psecurity"],date: ["ptype", "pdateformat", "poptions", "popt_required", "popt_unique", "psecurity", "pdefval_date", "pinstruct", "pconfine", "pconfine2"],time: ["ptype", "poptions", "popt_required", "popt_unique", "psecurity", "pdefval_time", "pinstruct", "pconfine", "pconfine2"],phone: ["ptype", "pphoneformat", "poptions", "popt_required", "popt_unique", "popt_authcode", "psecurity", "pdefval_phone_mobile", "pinstruct", "pconfine", "pconfine1", "pconfine2"],file: ["ptype", "poptions", "popt_required", "popt_compress", "psecurity", "pinstruct"],url: ["ptype", "pfldsize", "poptions", "popt_required", "popt_unique", "psecurity", "pdefval_text", "pinstruct", "pconfine", "pconfine2"],money: ["ptype", "pmoneyformat", "poptions", "popt_required", "popt_unique", "psecurity", "prange", "pdefval_number", "pinstruct", "pconfine", "pconfine2"],email: ["ptype", "pfldsize", "poptions", "popt_required", "popt_unique", "psecurity", "pdefval_text", "pinstruct", "pconfine", "pconfine1", "pconfine2"],name: ["ptype", "pnameformat", "poptions", "popt_required", "psecurity", "pinstruct", "pconfine", "pconfine1", "pconfine2"],address: ["ptype", "poptions", "popt_required", "psecurity", "pconfine", "pconfine2", "pdefval_addr", "pinstruct"]};
    $.each(b, function(d, e) {
        $("#" + e).hide()
    });
...
function createItems(g, b, d) {
    var f, a = {checkbox: DEFFLD.item_checkbox,goods: DEFFLD.item_goods,radio: DEFFLD.item_radio,dropdown: DEFFLD.item_radio,dropdown2: DEFFLD.item_radio,likertRow: DEFFLD.item_likert_row,likertCol: DEFFLD.item_likert_col};
    if (a[b] === undefined) {
        return
    }
    g.empty();
...
function propertyInit() {
    ...
    $("#btnItemsPredefine").click(function() {
        ...
        $.lightBox({url: "/rs/html/predefinechoices.html",confirm: function() {
                x("radio");
                CHANGED = true
            },loaded: function() {
                var P = "";
    ...
    $("#btnItemsBatch").click(function() {
        ...
        $.lightBox({url: "/rs/html/itembatchedit.html",confirm: function() {
                x(F[IDX].TYP);
    ...
    $("#btnLikertPredefine").click(function() {
        ...
        $.lightBox({url: "/rs/html/predefinelikert.html",confirm: function() {
...
function saveForm(d, e) {
    ...
    $.postJSON(b, c, function(f) {
        ...
        CHANGED = false;
        if (d) {
            $.lightBox({url: "/rs/html/formsaved.html",loaded: function() {
...
function formInit() {
    ...
    $("#btnPaySetting").click(function() {
        var j = function() {
            $.lightBox({url: "/rs/html/paysetting.html?v=1",confirm: function() {
    ...
    $("#btnPubDataSetting").click(function() {
        var j = function() {
            $.showStatus("正在加载...");
            $.lightBox({url: "/rs/html/publicdatasetting.html",loaded: function() {
                    loadedSetting()
                },confirm: function() {
