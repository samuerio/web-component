(function() {
    ...
    function style_html(html_source, options, js_beautify, css_beautify) {
        ...
        function Parser() {
            ...
            this.Utils = {whitespace: "\n\r	 ".split(""),single_token: "br,input,link,meta,!doctype,basefont,base,area,hr,wbr,param,img,isindex,?xml,embed,?php,?,?=".split(","),extra_liners: "head,body,/html".split(","),in_array: function(what, arr) {
            ...
            this.get_tag = function(peek) {
                var input_char = "", content = [], comment = "", space = false, tag_start, tag_end, tag_start_char, orig_pos = this.pos, orig_line_char_count = this.line_char_count;
