var Zepto = function() {
    function M(t) {
        return null == t ? String(t) : E[j.call(t)] || "object"
    }
    function L(t) {
        return "function" == M(t)
    }
    ...
    function Z(t) {
        return $(t) && !A(t) && Object.getPrototypeOf(t) == Object.prototype
    }
    function k(t) {
    ...
    function V(n, i, r) {
        for (e in i)
            r && (Z(i[e]) || D(i[e])) ? (Z(i[e]) && !Z(n[e]) && (n[e] = {}), D(i[e]) && !D(n[e]) && (n[e] = []), V(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
    }
    function X(t, e) {
    ...
    return S.matches = function(t, e) {
        ...
        return o && (r = C).appendChild(t), i = ~S.qsa(r, e).indexOf(t), o && C.removeChild(t), i
    }, N = function(t) {
        ...
        return R(t) && s && i ? (n = t.getElementById(a)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : o.call(s && !i ? r ? t.getElementsByClassName(a) : t.getElementsByTagName(e) : t.querySelectorAll(e))
    }, n.contains = function(t, e) {
        return t !== e && t.contains(e)
    }, n.type = M, n.isFunction = L, n.isWindow = A, n.isArray = D, n.isPlainObject = Z, n.isEmptyObject = function(t) {
        var e;
        for (e in t)
            return !1;
        return !0
        ...
        E["[object " + e + "]"] = e.toLowerCase()
            ...
            return L(t) ? this.not(this.not(t)) : n(a.call(this, function(e) {
            ...
            if (L(e) && e.call !== t)
                ...
                var r = "string" == typeof e ? this.filter(e) : k(e) && L(e.item) ? o.call(e) : n(e);
            ...
            return "string" == typeof n && i === t ? 0 == this.length || 1 !== this[0].nodeType ? t : "value" == n && "INPUT" == this[0].nodeName ? this.val() : !(r = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : r : this.each(function(t) {
                if (1 === this.nodeType)
                    if ($(n))
                        ...
                        Y(this, n, B(this, i, t, this.getAttribute(n)))
            })
            ...
            if (t)
                return this.each(function(e) {
                    var i = n(this), r = B(this, t, e, i.offset()), o = i.offsetParent().offset(), a = {top: r.top - o.top,left: r.left - o.left};
            ...
            if (arguments.length < 2) {
                ...
                if (D(t)) {
                    var a = {};
                    return n.each(D(t) ? t : [t], function(t, e) {
                        a[e] = r.style[N(e)] || o.getPropertyValue(e)
                    }), a
                }
            }
            var s = "";
            if ("string" == M(t))
                i || 0 === i ? s = F(t) + ":" + U(t, i) : this.each(function() {
                    this.style.removeProperty(F(t))
                });
            else
                for (e in t)
                    t[e] || 0 === t[e] ? s += F(e) + ":" + U(e, t[e]) + ";" : this.each(function() {
            ...
            return this.each(function(n) {
                return e === t ? J(this, "") : (i = J(this), B(this, e, n, i).split(/\s+/g).forEach(function(t) {
                    i = i.replace(q(t), " ")
                }), void J(this, i.trim()))
            })
        },toggleClass: function(e, i) {
            return e ? this.each(function(r) {
                var o = n(this), a = B(this, e, r, J(this));
        ...
        n.fn[e] = function(r) {
            var o, a = this[0];
            return r === t ? A(a) ? a["inner" + i] : R(a) ? a.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function(t) {
                a = n(this), a.css(e, B(this, r, t, a[e]()))
            })
        }
            ...
            return r.length < 1 ? this : this.each(function(t, s) {
                o = i ? s : s.parentNode, s = 0 == e ? s.nextSibling : 1 == e ? s.firstChild : 2 == e ? s : null, r.forEach(function(t) {
                    if (a)
                        ...
                        return n(t).remove();
                    W(o.insertBefore(t, s), function(t) {
    ...
    }), S.Z.prototype = n.fn, S.uniq = P, S.deserializeValue = G, n.zepto = S, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    }, a = {}, s = {}, u = "onfocusin" in window, f = {focus: "focusin",blur: "focusout"}, c = {mouseenter: "mouseover",mouseleave: "mouseout"};
    s.click = s.mousedown = s.mouseup = s.mousemove = "MouseEvents", t.event = {add: v,remove: y}, t.proxy = function(e, n) {
        if (r(e)) {
            var i = function() {
    ...
    var w = function() {
        ...
        return !1
    }, b = /^([A-Z]|returnValue$|layer[XY]$)/, T = {preventDefault: "isDefaultPrevented",stopImmediatePropagation: "isImmediatePropagationStopped",stopPropagation: "isPropagationStopped"};
    ...
    t.fn.data = function(e, n) {
        ...
        }) : 0 == this.length ? void 0 : a(this[0], e) : this.each(function() {
            s(this, e, n)
        })
    ...
    t.active = 0, t.ajaxJSONP = function(i, r) {
        ...
        p(n), n.crossDomain || (n.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(n.url) && RegExp.$2 != window.location.host), n.url || (n.url = window.location.toString()), T(n), n.cache === !1 && (n.url = b(n.url, "_=" + Date.now()));
        var a = n.dataType, s = /\?.+=\?/.test(n.url);
        if ("jsonp" == a || s)
            return s || (n.url = b(n.url, n.jsonp ? n.jsonp + "=?" : n.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(n, o);
    ...
    t(document).ready(function() {
        ...
        "MSGesture" in window && (s = new MSGesture, s.target = document.body), t(document).bind("MSGestureEnd", function(t) {
            ...
            (!(w = p(o, "up")) || h(o)) && (c(), e.x2 && Math.abs(e.x1 - e.x2) > 30 || e.y2 && Math.abs(e.y1 - e.y2) > 30 ? r = setTimeout(function() {
                ...
                var i = t.Event("tap");
                i.cancelTouch = l, i.stopPropagation = function() {
                    o.stopPropagation()
                }, i.preventDefault = function() {
                    o.preventDefault()
                }, e.el.trigger(i), e.isDoubleTap ? (e.el && e.el.trigger("doubleTap"), e = {}) : n = setTimeout(function() {
